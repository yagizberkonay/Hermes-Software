...
export const STR = {
  en: {
    ...
    overlays: {
      studio: {
        title: "STUDIO",
        category: "HERMES",
        description: "Independent software studio. Small team, sharp point of view, working software every week.",
        body: "We design, engineer and ship digital products from the first sketch to production.",
      },
      care: {
        title: "HERMES CARE",
        category: "SERVICE",
        description: "Post-launch support for products that still have places to go.",
  ...
  tr: {
    ...
    work: {
      ...
      cta: "PROJE BAŞLAT →",
      projects: [
        { title: "ONYX", category: "API İSTEMCİSİ", filter: "SOFTWARE", year: "2025", desc: "Postman'e daha hızlı, daha sade bir alternatif — sadece bir endpoint'i test etmek isteyen geliştiriciler için, şişkinlik olmadan.", result: "%30 DAHA KULLANICI DOSTU", img: "https://static.prod-images.emergentagent.com/jobs/11657cd1-e0a5-4774-9699-79e768a133c1/images/d203f257ff219869bb7268918d8c5c8a27f94cd5fe2bb2d79eed12f2d111c47e.jpeg" },
        { title: "PROMPT SHRINK", category: "LLM GEÇİDİ", filter: "AI", year: "2025", desc: "Uygulamanız ile herhangi bir LLM arasına giren, anlamı kaybetmeden prompt'ları sıkıştıran bir geçit.", result: "-%60 TOKEN KULLANIMI", img: "https://static.prod-images.emergentagent.com/jobs/11657cd1-e0a5-4774-9699-79e768a133c1/images/c5ff605149c5c8ad44902b951f0b6afc50a7f9cdadb7e7add2d9ed7f74147ab6.jpeg" },
        { title: "MOMENT", category: "MASAÜSTÜ ARACI", filter: "SYSTEMS", year: "2025", desc: "Bilgisayarınız için kişisel dijital bağlam — ne yaptığınızı sessizce anlar ve ihtiyacınız olanı, ihtiyacınız olduğunda gösterir.", result: "DAHA GÜÇLÜ MASAÜSTÜ BAĞLAMI", img: "https://static.prod-images.emergentagent.com/jobs/11657cd1-e0a5-4774-9699-79e768a133c1/images/77bfd7ecbe2c8ed4590926df41c861f6ec33b0eda23e6d4f6cb28c03ef816039.jpeg" },
      ],
    },
    testimonials: {
    ...
    overlays: {
      studio: {
        title: "STÜDYO",
        category: "HERMES",
        description: "Bağımsız yazılım stüdyosu. Küçük ekip, net duruş, her hafta çalışan yazılım.",
        body: "Dijital ürünleri ilk eskizden üretime kadar tasarlar, geliştirir ve yayına alırız.",
      },
      care: {
        title: "HERMES CARE",
        category: "HİZMET",
        description: "Yayın sonrası destek — hâlâ gidecek yeri olan ürünler için.",
